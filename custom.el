(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (py-isort emacs-emojify emojify company-go go-autocomplete atom-one-dark-theme which-key ocp-indent merlin utop pandoc-mode company highlight-tail swiper-helm evil-numbers atom-dark-theme js2-mode resize-window apropos use-package pymacs sml-mode quack multi-term persp-projectile perspective zenburn-theme yaml-mode xclip workgroups web undo-tree twilight-theme tuareg sos solarized-theme smartparens smart-mode-line rvm ruby-end ruby-electric rinari phi-search-mc pbcopy org-plus-contrib org-gcal org-bullets org-ac matlab-mode markdown-mode makefile-runner magit-gh-pulls latex-preview-pane jedi imenu+ ido-vertical-mode idle-highlight-mode icicles hexrgb helm-swoop helm-spotify helm-projectile helm-ag haskell-mode groovy-mode goto-chg go-mode gitignore-mode gitconfig-mode gitattributes-mode git-timemachine fuzzy-match fuzzy fsharp-mode flycheck flatland-black-theme f expand-region exec-path-from-shell erlang ensime emamux elfeed ein dropdown-list discover dirtree csharp-mode color-theme-wombat color-theme-twilight color-theme-solarized color-theme-sanityinc-tomorrow color-theme-approximate calfw-gcal calfw base16-theme awk-it autopair auto-complete-clang auctex aggressive-indent ace-jump-mode ac-math ac-etags ac-cider)))
